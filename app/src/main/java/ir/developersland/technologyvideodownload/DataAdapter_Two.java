...
public class DataAdapter_Two extends RecyclerView.Adapter<DataAdapter_Two.ViewHolder> {
    private ArrayList<CardViewModel> android;
    private Context context;

    public DataAdapter_Two(Context context, ArrayList<CardViewModel> android) {
        this.android = android;
        this.context = context;
    }

    @Override
    public DataAdapter_Two.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_view_minimum, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final DataAdapter_Two.ViewHolder viewHolder, final int i) {
