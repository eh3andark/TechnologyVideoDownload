package ir.developersland.technologyvideodownload.Graphic.Digital_Painting;
...
public class List_Digital_Painting extends AppCompatActivity {
    ListView list;
    String[] web = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(List_Digital_Painting.this, web, image_url);
