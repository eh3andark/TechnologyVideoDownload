package ir.developersland.technologyvideodownload.Graphic.Animation_2D;
...
public class List_Animation_2D extends AppCompatActivity {
    ListView list;
    String[] web = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(List_Animation_2D.this, web, image_url);
