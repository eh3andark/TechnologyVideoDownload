 ...
 */public class A_D extends Fragment {
    ...
    private String urlJsonObj = "http://developersland.ir/Android/Json_git/Graphic/ZBrush/4.json";
    private String download_url_1;
    public static String TAG = A_D.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Picasso.with(context).load("http://i.git.ir/DigitalTutors_NanoMesh_Workflows_in_ZBrush.jpg").resize(600, 300).centerCrop().into(image);
