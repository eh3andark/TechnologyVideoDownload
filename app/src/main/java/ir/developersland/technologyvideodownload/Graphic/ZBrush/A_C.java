 ...
 */public class A_C extends Fragment {
    ...
    private String urlJsonObj = "http://developersland.ir/Android/Json_git/Graphic/ZBrush/3.json";
    private String download_url_1;
    public static String TAG = A_C.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Picasso.with(context).load("http://i.git.ir/DigitalTutors_Rapidly_Creating_Stylized_Game_Assets_in_ZBrush.jpg").resize(600, 300).centerCrop().into(image);
