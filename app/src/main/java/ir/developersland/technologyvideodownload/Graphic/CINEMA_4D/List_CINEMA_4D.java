package ir.developersland.technologyvideodownload.Graphic.CINEMA_4D;
...
public class List_CINEMA_4D extends AppCompatActivity {
    ListView list;
    String[] web = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(List_CINEMA_4D.this, web, image_url);
