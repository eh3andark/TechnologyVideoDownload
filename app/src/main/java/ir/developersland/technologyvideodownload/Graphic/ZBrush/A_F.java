 ...
 */public class A_F extends Fragment {
    ...
    private String urlJsonObj = "http://developersland.ir/Android/Json_git/Graphic/ZBrush/6.json";
    private String download_url_1, download_url_2;
    public static String TAG = A_F.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Picasso.with(context).load("http://i.git.ir/DigitalTutors_Designing_a_Character_for_Mobile_Games_in_ZBrush.jpg").resize(600, 300).centerCrop().into(image);
