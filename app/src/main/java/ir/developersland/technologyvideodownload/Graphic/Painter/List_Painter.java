package ir.developersland.technologyvideodownload.Graphic.Painter;
...
public class List_Painter extends AppCompatActivity {
    ListView list;
    String[] web = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(List_Painter.this, web, image_url);
