package ir.developersland.technologyvideodownload.Graphic.Logo_Design;
...
public class List_Logo_Design extends AppCompatActivity {
    ListView list;
    String[] web = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(List_Logo_Design.this, web, image_url);
