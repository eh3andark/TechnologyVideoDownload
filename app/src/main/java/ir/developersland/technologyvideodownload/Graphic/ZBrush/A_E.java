 ...
 */public class A_E extends Fragment {
    ...
    private String urlJsonObj = "http://developersland.ir/Android/Json_git/Graphic/ZBrush/5.json";
    private String download_url_1, download_url_2;
    public static String TAG = A_E.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Picasso.with(context).load("http://i.git.ir/Digital_Tutors_Sculpting_a_Stylized_Axe_in_ZBrush.jpg").resize(600, 300).centerCrop().into(image);
